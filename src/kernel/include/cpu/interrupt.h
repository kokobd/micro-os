...
extern void cpu_syscallHandler(cpu_RegState *regState);

extern void cpu_extIntHandler(uint32_t irq_num, cpu_RegState *regState);
 ...
 */
extern void cpu_excHandler(enum cpu_Exception exception, cpu_RegState *regState);
